...
type_synonym ('index,'input,'bool) dist2 = "('input \<times> 'index \<times> 'bool \<times> 'bool) \<Rightarrow> bool spmf"

type_synonym ('index,'range, 'bool,'output,'input) advP2 = "('index,'input,'bool) dist2 \<Rightarrow> 'index \<Rightarrow> 'input \<Rightarrow> 'output \<Rightarrow> 'range \<Rightarrow> bool spmf"
